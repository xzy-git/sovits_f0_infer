...
infer_tool.mkdir(paths=["./raw", "./pth", "./results"])
...
infer_tool.fill_a_to_b(a=trans, b=clean_names)
infer_tool.mkdir(paths=[input_wav_path, out_wav_path])
...
for clean_name, tran in zip(clean_names, trans):
    ...
    for spk_id in id_list:
        # 清除缓存文件
        infer_tool.del_temp_wav(path_data="./wav_temp")
        var_list = []
        mis_list = []
